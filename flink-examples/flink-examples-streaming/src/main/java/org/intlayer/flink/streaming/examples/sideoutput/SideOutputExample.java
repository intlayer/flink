...
package org.intlayer.flink.streaming.examples.sideoutput;
 ...
 * org.intlayer.flink.streaming.examples.windowing.WindowWordCount} that has a filter in the
 * tokenizer and only emits some words for counting while emitting the other words to a side output.
 */
