...
import org.intlayer.flink.streaming.examples.iteration.util.IterateExampleData;
...
public class StreamingExamplesITCase extends AbstractTestBase {
    ...
    public void testIterateExample() throws Exception {
        ...
        org.intlayer.flink.streaming.examples.iteration.IterateExample.main(
                new String[] {
                    "--input", inputPath,
                    "--output", resultPath
                });
    ...
    public void testWindowJoin() throws Exception {
        ...
        try {
            ...
            org.intlayer.flink.streaming.examples.join.WindowJoin.runWindowJoin(
                            grades, salaries, 100)
    ...
    public void testSessionWindowing() throws Exception {
        final String resultPath = getTempDirPath("result");
        org.intlayer.flink.streaming.examples.windowing.SessionWindowing.main(
    ...
    public void testWindowWordCount() throws Exception {
        ...
        org.intlayer.flink.streaming.examples.windowing.WindowWordCount.main(
                new String[] {
                    "--input", textPath,
                    "--output", resultPath,
                    "--window", windowSize,
